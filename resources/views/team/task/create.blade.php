            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-start mb-4">
                      <button onclick="location.href='{{ route('team_task.index', ['team' => $team->id]) }}'" class="text-end btn btn-primary">戻る</button>
                    </div>
                    ...
                    @endif
                    <form action="{{ route('team_task.store', ['team' => $team->id]) }}" method="post">
                      @csrf
                      <div class="mb-4">
